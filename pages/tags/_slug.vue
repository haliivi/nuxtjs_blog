<template>
    <div class="container">
        <p class="my-3">Другие теги:
            <nuxt-link :to="`/tags/${tag.name}`" class="badge text-bg-info me-1" v-for="tag in tags" :key="tag.name">#{{tag.name}} </nuxt-link>
        </p>
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            <span v-for="tag in post.tags">
                                <nuxt-link :to="`/tags/${tag}`" class="badge text-bg-info me-1">#{{ tag }}</nuxt-link>
                            </span>
                        </div>
